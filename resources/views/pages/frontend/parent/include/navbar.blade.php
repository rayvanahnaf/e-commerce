                ...
                <ul class="fixed bg-white inset-0 flex flex-col invisible items-center justify-center opacity-0 md:visible md:flex-row md:bg-transparent md:relative md:opacity-100 md:flex md:items-center"
                    ...
                    @foreach ($category as $item)
                        <li class="mx-3 py-6 md:py-0">
                            <a href="#" class="text-black hover:underline">{{ $item->name }}</a>
                        </li>
                    @endforeach     
                </ul>
            </div>
            <div class="w-auto">
                <ul class="items-center flex">
                    @if (Auth::check()) 
                        ...
                        @endif
                    @else
                        <li class="mx-2   rounded border text-black hover:bg-black hover:text-pink-400 rounded-xl px-3 text-black py-1 inline-block flex-none transition duration-200 ">
